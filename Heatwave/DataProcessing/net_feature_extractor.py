...
def net_feature_loader(
    ...
    if recalc_features:
        spectrograms_train, murmurs_train, outcomes_train, records = calc_patient_features(
        ...
        spectrograms_test, murmurs_test, outcomes_test, _ = calc_patient_features(
            test_data_directory
        )
...
def calc_patient_features(data_directory):
    ...
    if "yaseen" in data_directory:
        ...
        for i in range(num_patient_files):
            ...
            current_spectrograms, current_records = load_spectrograms(data_directory, current_patient_data) # Get spectrograms per patient -> Adjust for Yaseen
            spectrograms.append(current_spectrograms)
    ...
    return spectrograms, murmurs, outcomes, records
